...
export default function* rootSaga(){
    yield [
        ...
        fork(register.watchChangePassword),
        ...
        fork(Admin.watchSpecificEmployee),
        ...
        fork(Admin.watchGetAllApplications),
        fork(Admin.watchAcceptApplication),
        fork(Admin.watchRejectApplication),
        fork(Admin.watchSpecificPost),
        fork(Admin.watchGetAllEmployees),
        fork(Admin.watchBlockUnblockEmployee),
