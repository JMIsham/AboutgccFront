...
export const EMPLOYER_EMAIL_REQUESTED="employer-email-requested";
export const EMPLOYER_EMAIL_PASSED="employer-email-passed";
export const EMPLOYER_EMAIL_FAILED="employer-email-failed";
...
export const ADMIN_SPECIFIC_POST_REQUESTED = "admin-specific-post-requested";
