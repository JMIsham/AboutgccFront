...
Form=connect(state => (
    ...
    initialValues: {
        ...
        about_job:state.employerReducer.currentPost.about_job,
        about_salary:state.employerReducer.currentPost.about_salary,
        about_skill:state.employerReducer.currentPost.about_skill
